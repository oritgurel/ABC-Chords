    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoSheet.equals(_existingSheet)) {
          throw new IllegalStateException("Migration didn't properly handle Sheet(com.oritmalki.mymusicapp2.model.Sheet).\n"
                  + " Expected:\n" + _infoSheet + "\n"
                  + " Found:\n" + _existingSheet);
        }
        ...
        if (! _infoMeasure.equals(_existingMeasure)) {
          throw new IllegalStateException("Migration didn't properly handle measure(com.oritmalki.mymusicapp2.model.Measure).\n"
                  + " Expected:\n" + _infoMeasure + "\n"
                  + " Found:\n" + _existingMeasure);
        }
        ...
        if (! _infoBeat.equals(_existingBeat)) {
          throw new IllegalStateException("Migration didn't properly handle beat(com.oritmalki.mymusicapp2.model.Beat).\n"
                  + " Expected:\n" + _infoBeat + "\n"
                  + " Found:\n" + _existingBeat);
        }
      }
