...
public class MeasureDao_Impl implements MeasureDao {
  ...
  private final EntityInsertionAdapter __insertionAdapterOfMeasure_1;
  ...
  public MeasureDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMeasure_1 = new EntityInsertionAdapter<Measure>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR ABORT INTO `measure`(`sheetId`,`measure_number`,`time_signature`,`showTimeSig`,`beats`,`numerator`,`denominator`) VALUES (?,?,?,?,?,?,?)";
      }
  ...
  public void newMeasure(Measure measure) {
    __db.beginTransaction();
    try {
      __insertionAdapterOfMeasure_1.insert(measure);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void deleteAll(List<Measure> measures) {
    __db.beginTransaction();
    try {
      __deletionAdapterOfMeasure.handleMultiple(measures);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public LiveData<List<Measure>> getAll() {
    final String _sql = "SELECT * FROM measure";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return new ComputableLiveData<List<Measure>>() {
      private Observer _observer;

      @Override
      protected List<Measure> compute() {
        if (_observer == null) {
          _observer = new Observer("measure") {
            @Override
